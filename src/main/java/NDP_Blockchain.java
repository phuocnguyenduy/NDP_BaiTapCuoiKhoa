...
public class NDP_Blockchain {
    public static ArrayList<VNPT_Phuoc> blockchain = new ArrayList<VNPT_Phuoc>();
    public static int difficulty = 5;
    public static float minimumTransaction = 0.1f;
    public static NDP_Store NDP_Kho; //Kho
    public static NDP_Store NDP_Cuahang; //Cửa hàng
    ...
    public static void main(String[] args) {
        ...
        //Tạo ra các store
        NDP_Kho = new NDP_Store();
        NDP_Cuahang = new NDP_Store();
        NDP_Store coinbase = new NDP_Store();
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, NDP_Kho.publicKey, initBalanceA, null);
        ...
        VNPT_Phuoc genesis = new VNPT_Phuoc("0");
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router trong kho là : " + NDP_Kho.getBalance());
        ...
        genesisTransaction = new Transaction(coinbase.publicKey, NDP_Cuahang.publicKey, initBalanceB, null);
        genesisTransaction.generateSignature(coinbase.privateKey); //Gán private key (ký thủ công) vào giao dịch gốc
        ...
        genesis.addTransaction(genesisTransaction);
        addBlock(genesis);
        System.out.println("-Số lượng VNPT-Net Router đang có tại Cửa hàng là : " + NDP_Cuahang.getBalance());
        VNPT_Phuoc block1 = new VNPT_Phuoc(genesis.hash);
        boolean fail = true;
        while (fail){
            ...
            sendFund = NDP_Kho.sendFunds(NDP_Cuahang.publicKey, numberTransfer);
            if (sendFund==null){
                continue;
            }else{
                fail= false;
        ...
        System.out.println("-Số lượng VNPT-Net Router trong kho hiện tại là : " + NDP_Kho.getBalance());
        System.out.println("-Số lượng VNPT-Net Router của Cửa hàng hiện tại là : " + NDP_Cuahang.getBalance());
    }
    public static Boolean isChainValid() {
        VNPT_Phuoc currentBlock;
        VNPT_Phuoc previousBlock;
    ...
    public static void addBlock(VNPT_Phuoc newBlock) {
        newBlock.mineVNPT_Phuoc(difficulty);
